    ...
    <div className="h-screen w-full">
      ...
      <div>
        <div className="flex flex-col justify-center items-center content-center mt-4">
          <div className="text-3xl uppercase">{Pokemon?.name}</div>
          <div
        ...
        <div className="flex mt-4 justify-between">
          ...
          <div className=" perspective-400  ml-5 ">
            {/* perspective-400 */}
            <div className="transform rotate-y-30  rounded-lg p-5 w-[300px] ">
                ...
                {Pokemon?.moves.byLevelUp.slice(0, 5).map((item, index) => (
                  <div key={index} className="flex items-center">
                    <img
                      ...
                      style={{
                        backgroundColor:
                          ColorPokemon[Pokemon?.type[0] as TypeMove],
                      }}
          ...
          <div className=" perspective-400  mr-5 font-kanit">
            <div className=" transform -rotate-y-30 w-[275px] rounded-lg ">
              <h1 className="font-bold text-2xl">STATS</h1>
              <div className="flex justify-center items-center">
                <div
                  className="grid grid-cols-1 justify-items-center w-[75px] h-[75px] rounded-full"
                  style={{
                    backgroundColor:
                ...
                <div className="flex justify-center items-center">
                  ...
                  >
                    <div
                      ...
                      style={{ width: `${progressBar(Pokemon?.stats.speed)}%` }}
                    ></div>
                  </div>
